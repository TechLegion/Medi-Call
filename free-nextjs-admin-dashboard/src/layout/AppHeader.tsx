...
const AppHeader: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      ...
      <div className="relative">
        <button
          className="relative p-2 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/20 transition-colors"
          onClick={() => {
          ...
          <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50">
            ...
            <ul className="max-h-80 overflow-y-auto divide-y divide-gray-100 dark:divide-gray-700">
              {notifications.length === 0 && (
                <li className="p-4 text-gray-500 dark:text-gray-400 text-center">No notifications</li>
              )}
              {notifications.slice(0, 10).map((notif) => (
                <li key={notif.id} className={`p-4 text-sm ${notif.is_read ? "text-gray-500 dark:text-gray-400" : "text-gray-900 dark:text-white bg-blue-50 dark:bg-blue-900/20"}`}>
